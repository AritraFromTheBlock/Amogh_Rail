  ...
  return (
    <div className="space-y-6 max-w-[1600px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start relative">
        ...
        {/* Left Column: Network & Movements */}
        <div className={`lg:col-span-3 space-y-6 transition-opacity duration-300 ${isExpanded ? 'opacity-0 pointer-events-none absolute' : 'opacity-100 relative'}`}>
          ...
          <div className="space-y-3">
            ...
            <div 
              className="border border-[rgba(15,44,92,0.10)] dark:border-white/10 bg-white dark:bg-[#111827] cursor-pointer hover:border-[#2F5FD1] transition-all"
          ...
          <div className="space-y-3">
            ...
            <div className="border border-[rgba(15,44,92,0.10)] dark:border-white/10 bg-white dark:bg-[#111827] divide-y divide-[rgba(15,44,92,0.08)] dark:divide-white/10 transition-colors">
        ...
        {/* Center Column: Live Traffic Simulation */}
        <div className={`flex flex-col shadow-lg transition-all duration-500 ease-in-out bg-white dark:bg-[#111827] ${isExpanded ? 'fixed inset-0 z-[100] h-screen w-screen' : 'lg:col-span-6 min-h-[600px] relative'}`}>
          ...
          <div className="flex-1 bg-[#F8F9FB] dark:bg-[#0f172a] border-x border-b border-[rgba(15,44,92,0.15)] dark:border-white/10 flex flex-col items-center justify-center relative overflow-hidden transition-colors">
        ...
        <div className={`lg:col-span-3 space-y-6 transition-opacity duration-300 ${isExpanded ? 'opacity-0 pointer-events-none absolute right-0' : 'opacity-100 relative'}`}>
          ...
          <div className="space-y-3">
            ...
            <div 
              className="border border-[rgba(15,44,92,0.10)] dark:border-white/10 bg-white dark:bg-[#111827] p-4 space-y-5 cursor-pointer hover:border-[#1E7F4F] transition-all"
          ...
          <div className="space-y-3">
            ...
            <div className="border border-[rgba(15,44,92,0.10)] dark:border-white/10 bg-white dark:bg-[#111827] divide-y divide-[rgba(15,44,92,0.08)] dark:divide-white/10">
              {[
